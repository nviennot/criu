...
static void handle_remote_accept(int fd)
{
	...
	/* This means that the no more images are coming. */
		...
		/*
		 * We had pending files to be sent. Now we now they will never come.
		 * If they did come, they would have been forwarded in finish_cache_write()
		 */
